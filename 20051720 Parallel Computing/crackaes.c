...
#pragma omp parallel for schedule(runtime) collapse(4) shared(exitLoop, success, dict_len) private(result, end, id, password) firstprivate(begin, ciphertext, cipher_len, plaintext, plainpassword, dict, key, iv, salt)     
